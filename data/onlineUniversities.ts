export const universities = [
  ...
  
    {
      ...
      intake: 'July Intake Open',
      programs: {
        ug: [],
        pg: ['MBA', 'MSc Data Science'],
      },
      benefits: [
        {
          title: 'QS Ranked',
  ...
  
    {
      ...
      image:
        'https://images.unsplash.com/photo-1491841550275-ad7854e35ca6?q=80&w=1400&auto=format&fit=crop',
      intake: 'Admissions Open',
      programs: {
        ug: ['BBA'],
        pg: ['MBA', 'MCA'],
  ...
  
    {
      ...
      benefits: [
        {
          title: 'Find Your Right University',
          icon: 'https://cdn-icons-png.flaticon.com/512/201/201623.png',
        },
        {
